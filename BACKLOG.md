...
- [x] **The landscape binds the project (2026-09-13).** A `related`/
  ...
  binding stamps `project_binding` ∈ operator/landscape/named/minted).
  ...
  fresh project three ways", item (4).
