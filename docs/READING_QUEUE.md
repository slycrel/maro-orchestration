...
|---|---|---|
| 2026-08-01 | [Run teachings design](https://github.com/slycrel/maro-orchestration/blob/main/docs/RUN_TEACHINGS_DESIGN.md) | **Updated 2026-08-02:** §4b RATIFIED (+ multiple-kinds-of-learning decree). §4a/§4d: record dig DONE — your probes-as-steps recollection verified exact (07-27 §14, decision `7061e85e`); [dig forensics + recommendation](https://github.com/slycrel/maro-orchestration/blob/main/docs/history/2026-08-02-probe-timing-record-dig.md) — call needed: mint-time probe vs **probe-gated first injection** (recommended). Plus **§4c-expanded** (worked examples): terrain at its own pre-planning surface?, self-teachings fully out of runs or caveat-grade visible? |
| 2026-08-02 | [Playbook surprise read](https://github.com/slycrel/maro-orchestration/blob/main/docs/history/2026-08-02-playbook-surprise-read.md) | Second self-maintained corpus, never operator-read — and it's injected into EVERY director/decompose call, so a wrong entry taxes every run. Same instrument as the lesson read (surprise + argue), entries numbered P1–P24, ~10 min. Companion notes flag truncated evolver lines and frozen drift alarms before you start. |
| 2026-07-31 | [Lesson-corpus surprise read](https://github.com/slycrel/maro-orchestration/blob/main/docs/history/2026-07-31-lesson-corpus-surprise-read.md) | **Chunk 1 DONE 2026-08-01** (recorded in-doc; collapse refuted, seed set M4+M12). Remaining: **chunk 2 = 8 family verdicts (F1–F8) + optional 5-row tail sample** — bottom of the same doc. Note: this was NOT covered in the other session (that was Round-3/continuation work) — still open. |
