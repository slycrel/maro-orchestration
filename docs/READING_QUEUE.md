...
|---|---|---|
| 2026-08-08 | [Δ-gate census round 2 + demotion shipped](https://github.com/slycrel/maro-orchestration/blob/main/docs/history/2026-08-06-delta-gate-validation.md) | Your agreeing-data condition MET (retest 3/3 same-sign: −0.137/−0.059/−0.078) → negative-Δ demotion is BUILT per the conditional grant (`demote_lesson_by_effect`, surface-scoped exactly as you framed it — stamp excludes from decision injection + blocks tenure-to-LONG; flat ledger/query untouched; killswitch in DEFAULTS.md). Two decisions: (1) run `--demote` on the three retested negatives now, or wait for more rounds? (2) First live adjustable-prior case: the sweep found the corpus's first POSITIVE Δs — two method-shaped lessons at +0.200/+0.167, both jackknife-dominant, both UNDER the 0.30 promote floor. Lower the floor (e.g. 0.15 with the dominance guard carrying more weight), or hold and gather? |
