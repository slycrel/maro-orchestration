...
- ledger last updated 3d ago — the count above is current enough to read as real.

**Throughput and fan-out**

- 54 commits in 7d, 281 in 30d
- **Actionable Stack** open boxes: **79** (30d: +18)
- net new open items per 10 commits: **+0.64** — findings are outrunning closure
...
- 26 entries that are narrative records with no open checkbox — shipped work, not queue
