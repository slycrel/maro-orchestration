...
- 253 commits in 7d, 738 in 30d
- **Actionable Stack** open boxes: **68** (30d: +62)
- net new open items per 10 commits: **+0.84** — findings are outrunning closure
...
- 20 entries with open work (9 of them waiting on evidence, not on a person)
- 19 entries that are narrative records with no open checkbox — shipped work, not queue

**11 live entries declare no stopping rule** — no kill criterion, falsifier, or evidence gate. These are where 0→1-approaching-1 rabbit holes live:
