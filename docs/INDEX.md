...
| Portable/shareable learning — migration + learning packs (1.0 item (g))? | `PORTABLE_LEARNING_DESIGN.md` (dormant-design; §8 RATIFIED 2026-07-12 — chunks 1-3 shipped, chunk 4 in progress) |
| How do I move a workspace to a new machine? | `MIGRATION.md` (living runbook; §7 chunk 1 SHIPPED 2026-07-12 — `maro-doctor` now checks config paths/stale state/index sync post-restore; chunk 3 SHIPPED 2026-07-13 — `maro-pack export`/`seal`) |
