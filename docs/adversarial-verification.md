...
- `docs/research-brief-persistence-and-zoom.md` — source of IMPL-003/IMPL-004 stale notes
...
**IMPL-003** | `contested` | Source: `docs/research-brief-persistence-and-zoom.md:94`
...
**IMPL-004** | `contested` | Source: `docs/research-brief-persistence-and-zoom.md:95`
...
**THEORY-002** | `contested` | Source: `docs/research-brief-persistence-and-zoom.md:64`
...
**THEORY-007** | `contested` | Source: `docs/research-brief-persistence-and-zoom.md:71`
...
**THEORY-011** | `contested` | Source: `docs/research-brief-persistence-and-zoom.md:76`
...
|---|----------|-------|--------|--------|
| 1 | CRITICAL | IMPL-003 | "Hash not yet present" → "_error_fingerprint() ships at agent_loop.py:2701" | research-brief-persistence-and-zoom.md §94 |
| 2 | CRITICAL | IMPL-004 | "Not wired" → "_is_converging() wired at agent_loop.py:3344" | research-brief-persistence-and-zoom.md §95 |
| 3 | CRITICAL | CODE-012 | Remove user/GOALS.md from missing-file list; file EXISTS | docs/md-claims-audit.md:49 |
| 4 | CRITICAL | THEORY-011 | Update status: "_is_converging() wired at agent_loop.py:3344" | research-brief-persistence-and-zoom.md:76 |
| 5 | HIGH | THEORY-009 | **BLOCK** Wave 3 confidence triggers; add LLM miscalibration caveat | productive_persistence.md + BACKLOG |
| 6 | HIGH | THEORY-002 | Update: hash IS wired; stuck_streak + _error_fingerprint + _is_converging all active | research-brief-persistence-and-zoom.md:64 |
| 7 | HIGH | THEORY-007 | Update from "partial (stuck_streak)" to full implementation status | research-brief-persistence-and-zoom.md:71 |
