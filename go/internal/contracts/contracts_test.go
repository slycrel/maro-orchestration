...
func samples() map[record.Kind]any {
	...
	return map[record.Kind]any{
		...
		run.KindPlan:                &run.Plan{Header: withSchema(h, "plan/1"), Invocation: inv, Steps: []thought.Ref{step}, Parallel: []run.ParallelStep{{Ordinal: 1, Goals: []thought.Ref{step, step}, Policy: run.JoinAll}}},
