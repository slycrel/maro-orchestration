...
sudo cp ~/.maro/workspace/deploy/systemd/maro-telegram.service /etc/systemd/system/
...
sudo cp ~/.maro/workspace/deploy/systemd/maro-heartbeat.service /etc/systemd/system/
...
sudo cp ~/.maro/workspace/deploy/systemd/maro-inspector.service /etc/systemd/system/
