...
def run_build_loop(
    *,
    ...
    with _try_lock(build_loop_lock_path()) as acquired:
        ...
        # tasks generated by orchestration itself. Passed via the bridge's
        # subprocess env, not os.environ — mutating the process-global env
        # races concurrent runs in the same process.
        try:
