...
# _build_loop_context, exec+analyze detection/splitting (_EXEC_KEYWORDS,
# _ANALYZE_KEYWORDS, _is_combined_exec_analyze, _split_exec_analyze,
# _shape_steps) moved to loop_planning.py (Tier 3 split).
