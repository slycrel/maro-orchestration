...
# ---------------------------------------------------------------------------
# Phases 59-60 (Feynman F4 verifier memory + verification-calibration loop)
# REMOVED 2026-08-08 by Jeremy's call (live-writer census survivor 1, decision
# 1addc859): dead at both ends -- record_verification's claimed caller
# (inspector.check_alignment) never existed, calibrated_alignment_threshold had
# zero src/ callers, verification_outcomes.jsonl frozen since 2026-04-12.
# Resurrect from git (this commit's parent) only WITH a live writer and a live
# consumer wired in the same change.
# ---------------------------------------------------------------------------
