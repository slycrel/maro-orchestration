...
def build_parser() -> argparse.ArgumentParser:
    ...
    autonomy_group.add_argument("--autonomy", dest="autonomy", action="store_const", const=True, default=None, help="Enable autonomous drains and background work in loop mode")
