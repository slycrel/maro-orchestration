...
# Retirement-by-contradiction (2026-08-02): a stored lesson was contested —
# by adjudication (a failed run plausibly failed *because* it applied the
...
# V3 (2026-08-02): a knowledge-web candidate node earned candidate → active
# (re-observed >= 2x by the bridge upsert, confidence gate met, optional LLM
# validation). Emitted by knowledge_web.promote_knowledge_candidates on the
...
# §9.5 mid-meander re-anchor (COMPOUND_THINKING_DESIGN, 2026-08-15): fires at
...
STEP_CEILING_ENFORCED = "STEP_CEILING_ENFORCED"
...
USER_SURFACED_EVENTS = frozenset({
    ...
    HYPOTHESIS_PROMOTED, HYPOTHESIS_CONTRADICTED, KNOWLEDGE_NODE_PROMOTED,
